...
<head>
	...
	<script src="${pageContext.request.contextPath}/resources/js/student/jquery-3.2.1.min.js"></script>
...
<script type="text/javascript">
    Vue.component('model', {
        ...
        template: `<div class="overlay" v-show="isactive">
                        ...
                        <tr>
                        <td>班级</td>
                        <td><input type="text" v-model="modifylist.clas"></td>
                        </td>
                        </tr>
                        <tr>
                        <td>性别</td>
                        <td><input type="text" v-model="modifylist.sex"></td>
                        </td>
                        </tr>
                        <tr>
                        <td>年龄</td>
                        <td><input type="text" v-model="modifylist.age"></td>
                        </td>
                        </tr>
                        <tr>
                        <td>分数</td>
    ...
    $.ajax({
        url:server_context + '/student/.json?_dc=1530084270505&page=1&start=0&limit=80',//实现跨域的URL路径
