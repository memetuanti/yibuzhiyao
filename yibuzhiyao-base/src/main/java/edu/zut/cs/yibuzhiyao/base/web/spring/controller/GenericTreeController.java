...
import edu.zut.cs.yibuzhiyao.base.service.GenericTreeManager;



@NoRepositoryBean
public class GenericTreeController <T extends BaseTreeEntity<T>, PK extends Serializable, M extends GenericTreeManager<T, PK>>
